export const translations = {
  en: {
    ...
    cat_file_system: 'File & System',
    cat_file_system_desc: 'Compression, file copy & sorting, system info, everyday utilities',
    cat_media: 'Media',
    cat_media_desc: 'Photo, video and audio processing, classification, streaming',
    cat_automation: 'Automation',
    cat_automation_desc: 'RPA, workflows, IoT, smart home, repetitive work & life tasks',
    cat_ai: 'AI Tools',
    cat_ai_desc: 'LLM agents, chatbots, autonomous assistants, AI-powered apps',
    cat_knowledge: 'Information & Learning',
    cat_knowledge_desc: 'Reference, dashboards, knowledge resources, tutorials, education',
    cat_experiments: 'Experiments & Fun',
    cat_experiments_desc: 'Games, interactive toys, creative experiments, fun projects',
  ...
  ko: {
    ...
    cat_file_system: '파일 & 시스템',
    cat_file_system_desc: '압축, 파일 복사·정리, 시스템 정보, 일상 유틸리티',
    cat_media: '미디어',
    cat_media_desc: '사진·영상·오디오 처리, 분류, 스트리밍',
    cat_automation: '자동화',
    cat_automation_desc: 'RPA, 워크플로우, IoT, 스마트홈, 반복 업무·생활 자동화',
    cat_ai: 'AI 도구',
    cat_ai_desc: 'LLM 에이전트, 챗봇, 자율 비서, AI 기반 앱',
    cat_knowledge: '정보 & 학습',
    cat_knowledge_desc: '참고 자료, 대시보드, 지식 자료, 튜토리얼, 교육',
    cat_experiments: '실험 & 재미',
    cat_experiments_desc: '게임, 인터랙티브 토이, 창의적 실험, 재미있는 프로젝트',
