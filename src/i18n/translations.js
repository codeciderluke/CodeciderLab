export const translations = {
  en: {
    ...
    cat_information_desc: 'Reference tools, data lookup, dashboards, knowledge resources',
    cat_automation: 'Work Automation',
    cat_automation_desc: 'RPA, script automation, repetitive task handling, workflow',
    cat_utilities: 'Utilities',
    cat_utilities_desc: 'File tools, system utilities, everyday productivity helpers',
    cat_life_automation: 'Life Automation',
    cat_life_automation_desc: 'Smart home, daily routines, IoT, personal life optimization',
    cat_ai_agent: 'AI Agent',
    cat_ai_agent_desc: 'LLM agents, chatbots, autonomous assistants, AI workflows',
    cat_play_toy: 'Play & Toy',
    cat_play_toy_desc: 'Games, interactive toys, creative experiments, fun projects',
    cat_education: 'Education',
    cat_education_desc: 'Learning tools, tutorials, coding practice, educational content',
  ...
  ko: {
    ...
    cat_information: '정보',
    cat_information_desc: '참고 도구, 데이터 조회, 대시보드, 지식 자료',
    cat_automation: '업무자동화',
    cat_automation_desc: 'RPA, 스크립트 자동화, 반복 업무 처리, 워크플로우',
    cat_utilities: '유틸리티',
    cat_utilities_desc: '파일 도구, 시스템 유틸리티, 일상 생산성 도우미',
    cat_life_automation: '생활 자동화',
    cat_life_automation_desc: '스마트홈, 일상 루틴, IoT, 개인 생활 최적화',
    cat_ai_agent: 'AI 에이전트',
    cat_ai_agent_desc: 'LLM 에이전트, 챗봇, 자율 비서, AI 워크플로우',
    cat_play_toy: '놀이 & 장난감',
    cat_play_toy_desc: '게임, 인터랙티브 토이, 창의적 실험, 재미있는 프로젝트',
    cat_education: '교육',
    cat_education_desc: '학습 도구, 튜토리얼, 코딩 연습, 교육 콘텐츠',
